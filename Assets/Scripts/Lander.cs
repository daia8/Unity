...
public class Lander : MonoBehaviour {
    ...
    public void TriggerOnLanded(OnLandedEventArgs args)
    {
        OnLanded?.Invoke(this, args);
    }
    ...
    private State state;
    private bool isImmuneToBullets = false;
    public bool IsImmuneToBullets => isImmuneToBullets;
